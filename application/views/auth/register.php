...
<?php endif; ?>
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-lg-8 col-12 order-lg-1 order-2 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="../assets/img/unsplash/login-bg.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold"><?php if (date("H") >= 0 && date("H") <= 12): ?>
                    Good Morning
        ...
        <div class="col-md-4 col-12 order-lg-2 min-vh-100 order-1 bg-white">
          <div class="p-4 m-3">
            ...
            <p class="text-muted">Register First</p>
            <form method="POST" action="<?= site_url('auth/register') ?>">
              <div class="form-group">
                <label for="email">First Name</label>
                <input id="email" type="text" class="form-control" name="first_name" tabindex="1" required autofocus>
              ...
              <div class="form-group">
                ...
                <input id="email" type="text" class="form-control" name="last_name" tabindex="1" required autofocus>
                <div class="invalid-feedback">
...
<div class="form-group">
              ...
              <div class="form-group text-right">
                ...
                <input type="submit" name="submit" class="btn btn-primary btn-lg btn-icon icon-right" tabindex="4" value="Register">
              </div>
              ...
              <div class="mt-5 text-center">
               Already Have An Account? <a href="<?php echo site_url('auth/login') ?>">Login</a>
              </div>
            </form>
